...
class EfficientNetConfig:
    """Конфигурация для обучения EfficientNet-B0 с GPU оптимизациями"""
    ...
    # Параметры модели
    MODEL_NAME = 'efficientnet_b0_gpu'
    NUM_CLASSES = 43
    INPUT_SIZE = 224
    
    # Параметры обучения (оптимизированные для GPU)
    BATCH_SIZE = 128  # Увеличен для эффективного использования GPU
    EPOCHS = 10
    LEARNING_RATE = 0.001
    WEIGHT_DECAY = 1e-4
    
    # GPU оптимизации
    USE_HALF_PRECISION = True  # Использовать FP16
    MEMORY_FRACTION = 0.95  # Использовать 95% GPU памяти
    ...
    # Устройство
    DEVICE = 'cuda'  # Автоматически определится
